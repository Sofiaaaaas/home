...
void Movie::set_date()
{
    ...
    std::cout << "Enter release date for " << this->title << " (year month day) : " << std::endl;
...
void Movie::print(Movie movie)
{
    ...
    std::cout << "Ranking - " << movie.get_ranking() << std::endl;
    std::cout << "Character number - " << movie.get_character_number() << std::endl;
    std::cout << "Ticket price - " << movie.get_ticket_price() << std::endl;
    std::cout << "Comment - " << movie.get_comment() << std::endl;
